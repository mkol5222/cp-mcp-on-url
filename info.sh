...
echo ""
echo "-- MCP Inspector CLI (no browser required) --"
echo ""
echo "List tools — quantum-management-mcp:"
echo "  npx -y @modelcontextprotocol/inspector --cli \"$BASE_URL/quantum/mcp\" --header \"X-Api-Key: $PROXY_API_KEY\" list-tools"
echo ""
echo "List tools — management-logs-mcp:"
echo "  npx -y @modelcontextprotocol/inspector --cli \"$BASE_URL/logs/mcp\" --header \"X-Api-Key: $PROXY_API_KEY\" list-tools"
echo ""
echo "Call a tool (replace <tool-name> and args as needed):"
echo "  npx -y @modelcontextprotocol/inspector --cli \"$BASE_URL/quantum/mcp\" --header \"X-Api-Key: $PROXY_API_KEY\" call-tool --tool-name <tool-name> --tool-arg key=value"
echo ""
