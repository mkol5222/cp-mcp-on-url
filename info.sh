...
echo "  npx -y @modelcontextprotocol/inspector --cli -- \"$BASE_URL/quantum/mcp\" --header \"X-Api-Key: $PROXY_API_KEY\" --method tools/list"
echo ""
echo "List tools — management-logs-mcp:"
echo "  npx -y @modelcontextprotocol/inspector --cli -- \"$BASE_URL/logs/mcp\" --header \"X-Api-Key: $PROXY_API_KEY\" --method tools/list"
echo ""
echo "Initialize (quantum-management-mcp):"
echo "  npx -y @modelcontextprotocol/inspector --cli -- \"$BASE_URL/quantum/mcp\" --header \"X-Api-Key: $PROXY_API_KEY\" --method tools/call --tool-name management__init"
echo ""
